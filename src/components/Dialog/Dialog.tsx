...
export const DialogOverlay = forwardRef<HTMLDivElement, DialogOverlayProps>(
  ({ className = '', ...props }, ref) => (
    <DialogPrimitive.Overlay
      ref={ref}
      className={`cui-dialog__overlay ${className}`}
      {...props}
    />
  )
);
  ...
  ({ className = '', children, ...props }, ref) => (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={`cui-dialog__content ${className}`}
        {...props}
      >
        {children}
        <DialogPrimitive.Close className="cui-dialog__close">
          <svg
            width="15"
            height="15"
            viewBox="0 0 15 15"
...
export const DialogTitle = forwardRef<HTMLHeadingElement, DialogTitleProps>(
  ({ className = '', ...props }, ref) => (
    <DialogPrimitive.Title
      ref={ref}
      className={`cui-dialog__title ${className}`}
      {...props}
    />
  )
);
...
export const DialogDescription = forwardRef<HTMLParagraphElement, DialogDescriptionProps>(
  ({ className = '', ...props }, ref) => (
    <DialogPrimitive.Description
      ref={ref}
      className={`cui-dialog__description ${className}`}
      {...props}
    />
  )
);
